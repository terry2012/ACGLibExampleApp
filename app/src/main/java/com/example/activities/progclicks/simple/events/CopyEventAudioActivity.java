...
/**
 * Activity which copies an event into the location of the Audio ACG and plays it back later
 */
public class CopyEventAudioActivity extends TimingButtonAudioActivity {

    @NonNull
    @Override
    public Collection<EvilDoer> evilDoers() {
        List<EvilDoer> evilDoers = (List<EvilDoer>) super.evilDoers();
        EvilDoer evilDoer = new CopyEventEvilDoer(R.id.audio_acg_button_id, R.id.malicious_disguised_button_id, 5000);

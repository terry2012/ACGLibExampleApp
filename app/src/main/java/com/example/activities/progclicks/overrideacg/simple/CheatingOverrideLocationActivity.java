...
/**
 * Programmatically click a button whose listener invokes an overridden ACG
 */
public class CheatingOverrideLocationActivity extends IndirectOverrideLocationActivity {

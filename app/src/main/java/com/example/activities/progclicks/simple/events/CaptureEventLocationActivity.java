...
/**
 * Activity which captrures an event into the location of the Location ACG and plays it back later
 * This should pass static validation and be caught at runtime
 */
public class CaptureEventLocationActivity extends TimingButtonLocationActivity {

    @NonNull
    @Override
    public Collection<EvilDoer> evilDoers() {
        List<EvilDoer> evilDoers = (List<EvilDoer>) super.evilDoers();
        EvilDoer evilDoer = new CaptureEventEvilDoer(R.id.location_acg_button_id, R.id.malicious_disguised_button_id, 5000);

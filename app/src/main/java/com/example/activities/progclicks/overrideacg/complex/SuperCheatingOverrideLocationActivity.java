...
/**
 * Programmatically click a button whose listener invokes several buttons and eventually invokes an overridden ACG
 */
public class SuperCheatingOverrideLocationActivity extends VeryIndirectOverrideLocationActivity {

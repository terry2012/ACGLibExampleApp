...
/**
 * Simple activity that programmatically clicks the location ACG button instead of waiting for user input
 */
public class ProgClickLocationActivity extends EvilLocationActivity {

    @NonNull
    @Override
    public Collection<EvilDoer> evilDoers() {
        List<EvilDoer> evilDoers = new ArrayList<>();
        EvilDoer evilDoer = new ProgClickEvilDoer(R.id.location_acg_button_id);

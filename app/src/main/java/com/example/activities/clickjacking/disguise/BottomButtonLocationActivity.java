...
/**
 * Clickjacking activity which puts the location ACG directly bellow a small harmless-looking button
 */
public class BottomButtonLocationActivity extends EvilLocationActivity {

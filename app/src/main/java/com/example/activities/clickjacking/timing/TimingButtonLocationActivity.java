 ...
 */
public class TimingButtonLocationActivity extends EvilLocationActivity {

    @Override
    public @NonNull Collection<EvilDoer> evilDoers() {
        List<EvilDoer> evilDoers = new ArrayList<>();
        EvilDoer evilDoer = new BaitAndSwitchEvilDoer(R.id.malicious_fragment_id, R.id.location_acg_fragment_id, 2000, 1000);
        evilDoers.add(evilDoer);
        return evilDoers;
    }

    protected int contentView() {
        return R.layout.activity_location_bottom;
    }
}
